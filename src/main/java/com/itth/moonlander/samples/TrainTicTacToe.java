 ...
 */
package com.itth.moonlander.samples;
...
public final class TrainTicTacToe {
	...
	public static TrainingResult runExample(String[] args) throws IOException {
		...
		gamesPerEpoch = Math.toIntExact(1024);

		final BaseNDManager manager = (BaseNDManager)NDManager.newBaseManager();
		TicTacToe game = new TicTacToe(manager, batchSize, replayBufferSize);
